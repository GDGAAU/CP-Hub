            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }}>
              <div
                style={{
                  ...
                  height: "40px",
                  borderRadius: "50%",
                  backgroundImage: `url('${user.profile_img || 'https://api.dicebear.com/7.x/avataaars/svg?seed=user'}')`,
                  backgroundSize: "cover",
                  border: "1px solid rgba(255, 255, 255, 0.08)",
                }}
              />
              <div style={{ minWidth: 0 }}>
                <div style={{ fontSize: "0.9375rem", fontWeight: "600", color: "#c4c4c4", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                  {user.name || user.username}
                </div>
                <div style={{ fontSize: "0.75rem", color: "#b5b5b4" }}>
                  Solved: {user.stats?.solved?.total_solved || 0}
                </div>
              </div>
            </div>
